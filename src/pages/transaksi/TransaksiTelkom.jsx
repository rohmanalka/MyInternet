...
const TransaksiTelkom = () => {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3000/products?provider=telkom")
      .then((res) => res.json())
            ...
            <Card className="shadow-md rounded-lg" sx={{ bgcolor: "rgba(255,255,255,0.4)", backdropFilter: "blur(8px)" }}>
              <CardContent className="flex items-center gap-6 p-6">
                <div className="flex-shrink-0">
                  <img src="/src/assets/provider/telkom.png" alt="Telkomsel" className="w-25 h-25 rounded-lg object-cover"/>
                </div>
                <div>
                  <h2 className="text-2xl font-bold mb-2">Telkomsel</h2>
                  <p className="text-gray-700 text-sm">
                    provider telekomunikasi digital terkemuka di Indonesia yang telah 
                    melayani masyarakat sejak tahun 1995. Telkomsel dikenal dengan 
